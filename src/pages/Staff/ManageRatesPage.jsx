    ...
    <div className={"pb-16"}>
      ...
      <form onSubmit={handleSubmit} className={"card m-4 p-2 text-secondary font-bold text-lg"}>
        <div className={""}>
          ...
          <input className="mt-2 mb-4 form-input !text-primary" id="perPageBw" name="perPageBw" type="number" step="0.01" value={rates.perPageBw} onChange={handleChange} required />
        </div>
        <div className={""}>
          <label className="" htmlFor="perPageColor">Cost per Color Page (₹)</label>
          <input className="mt-2 mb-4 form-input !text-primary" id="perPageColor" name="perPageColor" type="number" step="0.01" value={rates.perPageColor} onChange={handleChange} required />
        </div>
        <div className={""}>
          <label className="" htmlFor="doubleSidedMultiplier">Double-Sided Multiplier</label>
          <input className="mt-2 mb-4 form-input !text-primary" id="doubleSidedMultiplier" name="doubleSidedMultiplier" type="number" step="0.01" value={rates.doubleSidedMultiplier} onChange={handleChange} required />
        </div>
        <div className={""}>
          <label className="" htmlFor="staplingFee">Stapling Fee (₹)</label>
          <input className="mt-2 mb-4 form-input !text-primary" id="staplingFee" name="staplingFee" type="number" step="0.01" value={rates.staplingFee} onChange={handleChange} required />
        </div>
